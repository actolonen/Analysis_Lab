...
This notebook analyzes the growth of microbial cells in microplates. Functions are included that organize data from different plate readers:
...
1.  Page 1 = "Informations". Plate map describing experiment with these columns. NOTE: empty wells are written as "empty" in all columns except Well.
