---
title: "Initial enzyme reaction rate"
...
This notebook describes how to calculate the initial reaction rate of an enzyme based on the accumulation of product. As product accumulation saturates, the calculation of reaction rate requires the identification of the initial, linear portion of a curve.
...
Plot data
```{r plot data, fig.cap = "Fig: Enzyme catalyzed accumulation of product. Data points show product concentration and the black line shows the rate of product formation for the initial, linear portion of the curve."}
