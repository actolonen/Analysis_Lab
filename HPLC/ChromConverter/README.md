...
The code in this directory shows how use the read_shimadzu_lcd() function to extract chromatograms produced by the (Genoscope-CEA HPLC](https://github.com/actolonen/Analysis_Lab/tree/main/HPLC). 
