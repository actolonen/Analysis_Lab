...
The objective of this notebook is to evaluate if a new version of chromConverter produced by Ethan Bass can extract the chromatograms as .txt from .lcd files produced by the [HPLC at Genoscope-CEA](https://github.com/actolonen/Analysis_Lab/tree/main/HPLC).
