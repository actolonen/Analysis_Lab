...
table.out = "/home/tolonen/Github/actolonen/Public/Analysis_Lab/Metabolites/HPLC/Data/Analysis/standards_regressions_STD1.tsv";
...
table.standards = kable(my.standards, caption = "Table 1: Metabolite concentrations in STD1+2 water standards");
table.standards
...
```{r acetate RID: calc peaks and lm}
...
```{r acetate RID LM, fig.cap = "Linear model of peak area vs acetate concentration for all standards."}
...
```{r acetate UV210: calc peak areas and lm}
...
```{r acetate UV210 LM, fig.cap = "Linear regressions of peak area vs acetate concentration for all standards."}
...
```{r lactate RID: calc peak areas and lm}
...
```{r lactate LM RID: plot linear model, fig.cap = "Linear regressions of peak area vs lactate concentration for all standards."}
...
```{r lactate UV210: calc peak areas and lm}
...
```{r lactate LM UV210: plot linear model, fig.cap = "Linear regressions of peak area vs lactate concentration for all standards."}
...
```{r glucose: plot linear model, fig.cap = "Linear model of peak area vs glucose concentration for all standards."}
...
```{r propionate RID: calc peak areas and lm, eval=F}
...
```{r propionate RID: plot peaks, fig.cap = "Peak areas of propionate in each of the standards samples.", eval=F}
...
```{r propionate LM RID, fig.cap = "Linear regressions of peak area vs propionate concentration for all standards.", eval=F}
...
```{r propionate UV210: calc peak areas and lm, eval=F}
...
```{r propionate UV210: plot peaks, fig.cap = "Peak areas of propionate in each of the standards samples.", eval=F}
...
```{r propionate LM UV210: plot linear model, fig.cap = "Linear regressions of peak area vs propionate concentration for all standards.", eval=F}
...
lm.out = lm.out %>%
  rename(Compound = my.compound, Slope = my.slope, Y.Intercept = yint, Peak.start = peak.start, Peak.end = peak.end, Detector = my.detector);
